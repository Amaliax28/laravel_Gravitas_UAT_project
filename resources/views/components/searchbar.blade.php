            ...
            <form action="#">
                <div class="search-group d-flex flex-row align-items-center" id="searchBox">
                    ...
                    <input type="text" name="search" id="search"
                        placeholder="{{ isset($placeholder) ? $placeholder : 'Search project, session, test cases, etc' }}  "
                        class="w-100">
                </div>
            </form>
        </div>
...
<script>
    ...
    const searchFocusIcon = document.getElementById('searchFocus');
    ...
    searchInput.addEventListener('click', () => {
        ...
        searchFocusIcon.classList.remove('d-none');
    ...
    searchInput.addEventListener('blur', () => {
        ...
        searchFocusIcon.classList.add('d-none');
        searchInput.placeholder = "Search project, session, test cases, etc";
