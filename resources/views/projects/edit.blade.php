        ...
        <x-modal-form action="/projects/{{$project->id}}">
            ...
            <div class="form-container" >
                    ...
                    <div class="col">
                        <label for="projectImage">
                            ...
                            <div
                                ...
                                <img src="{{$project->projectImg ? asset('storage/'.$project->projectImg) : asset('images/no-image.png') }}" alt="" class="w-100 h-100 object-fit-cover " id="frame">
                ...
                <div class="row m-0 form-row ">
                    ...
                    <div class="col">
                        <input type="text" name="projectName" id="projectName" class="modal-input-border" value="{{$project->projectName}}">
                    </div>
                </div>
                <div class="row m-0 form-row">
                    <div class="col-auto label-container">
