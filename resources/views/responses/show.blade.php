    ...
    <x-content class="response">
        ...
        @unless (count($testcases) == 0)
            @foreach ($testcases as $testcase)
                <x-testcase-form action="/session/{{ $session->id }}/testcase/{{ $testcase->id }}/create" enctype="multipart/form-data" >
                    ...
                    <x-testcase-section>
                        <div class="response-container">
                            ...
                            @if (isset($responses) && $responses) <!-- IF USER HAS RESPONDED ON THT TEST CASE -->
                                    ...
                                    <div class="item-col">
                                        ...
                                        <x-testcase-requirements-container>
                                            ...
                                            <div class="row table-btn table-header {{ $errors->has('desktop') ? 'bg-primary-color' : '' }}"
                                                id="desktopCont">
                                                <button class="btn accept" id="btnAcceptDesktop" type="button"  data-active{{ $response->desktop == 'accept' ? '=true' : '' }}  disabled>
                                                    Accept
                                                    <input type="radio" name="desktop" value="accept"  class="d-none" id="acceptDesktop"
                                                    {{ $response->desktop == 'accept' ? 'checked' : '' }} >
                                                </button>
                                                <button class="btn reject" id="btnRejectDesktop" type="button" data-active{{ $response->desktop == 'reject' ? '=true' : '' }} disabled>
                                                    Reject
                                            ...
                                            <div class="row table-btn @error('desktop') bg-primary-color @enderror"
                                                id="mobileCont">
                                                <button class="btn accept" id="btnAcceptMobile" type="button" data-active{{ $response->mobile == 'accept' ? '=true' : '' }} disabled>
                                                    Accept
                                                    <input type="radio" name="mobile" value="accept"  class="d-none" id="acceptMobile"
                                                    {{ $response->mobile == 'accept' ? 'checked' : '' }}>
                                                </button>
                                                <button class="btn reject" id="btnRejectMobile" type="button" data-active{{ $response->mobile == 'reject' ? '=true' : '' }} disabled>
                                                    Reject
                                        ...
                                        <x-response-feedback-cont>
                                            <x-response-timestamp>
                                                @php
                                                    ...
                                                    $formatDuration = Carbon::now()->subSeconds($duration)->diff(Carbon::now())->format('%H:%I:%S');
                                            ...
                                            <div class="row m-0 overflow-hidden text-break ">
                                                ...
                                                <div class="col comment-cont ">
                                                    ...
                                                    <div class=" feedback">
                                                        <textarea name="responseText" id="feedback" class="text-start overflow-hidden" placeholder="{{ $response->responseText ? $response->responseText : 'no comment' }}" oninput="autoResize()" disabled></textarea>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            @else <!-- IF THERE IS NO RESPONSES YET -->
                                <!-- right side col-->
                                <div class="item-col">
                                    <!-- response requirements -->
                                    <x-testcase-requirements-container>
                                        ...
                                        <div class="row attachments p-0 flex-grow-1 ">
                                            <div class="mt-auto px-0  feedback-btm">
                                                <div class="comment-field">
                                                    ...
                                                    <div class="input-cont ">
                                                        <input type="file" accept="image/*" id="feedbackImg" name="feedbackImg"
                                                            class="d-none">
                                                        <label for="feedbackImg" class="input-icon">
                                                            <svg width="20" height="20" viewBox="0 0 32 32"
                                                                fill="none" xmlns="http://www.w3.org/2000/svg">
