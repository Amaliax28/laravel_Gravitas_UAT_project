<x-layout>
    <x-content>
        ...
        <section class="registerUser">
            <form method="POST" action="/users" id="regular-form" enctype="multipart/form-data">
                <div class="register-user d-flex flex-row ">
                    ...
                    <div class="row">
                        ...
                        <div class="col  p-0">
                            <input type="text" id="username" name="username" class="form-control field-padding form-field border-grey-10 h-100"
                            value="{{ old('username') }}">
                        </div>
                    </div>
                    @error('username')
                    ...
                    <div class="row">
                        ...
                        <div class="col  p-0">
                            <input type="email" id="email" name="email" class="form-control h-100 field-padding form-field border-grey-10"
                            value="{{ old('email') }}">
                        </div>
                        @error('email')
                            <p class="text-danger m-0 p-0 fs-sm ms-md-0 ms-2">{{ $message }}</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="input-group  password  border-grey-10  m-0 p-0 ">
                                <input type="text" id="password" name="password" class="form-control border-0 w-75 h-100 field-padding form-field border-grey-10">
